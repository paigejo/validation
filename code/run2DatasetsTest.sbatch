#!/bin/bash
#SBATCH --job-name run2DatasetsTest      # Set a name for your job. This is especially useful if you have multiple jobs queued.
...
#SBATCH --mem-per-cpu=3000     # Memory limit for each tasks (in MB) 6850
#SBATCH -o run2DatasetsTest_%A_%a.out    # File to which STDOUT will be written
#SBATCH -e run2DatasetsTest_%A_%a.err    # File to which STDERR will be written
